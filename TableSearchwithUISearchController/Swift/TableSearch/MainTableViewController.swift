...
Abstract:
The application's primary table view controller showing a list of jobs.
*/
...
class MainTableViewController: BaseTableViewController, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating {
    ...
    */
    ...
    @IBOutlet weak var jobCel: UITableViewCell!
    ...
    func updateSearchResultsForSearchController(searchController: UISearchController) {
        ...
        let andMatchPredicates: [NSPredicate] = searchItems.map { searchString in
            // Each searchString creates an OR predicate for: name, datePosted, jobSalary.
            //
            // Example if searchItems contains "iphone 599 2007":
            //      name CONTAINS[c] "iphone"
            //      name CONTAINS[c] "599", datePosted ==[c] 599, jobSalary ==[c] 599
            //      name CONTAINS[c] "2007", datePosted ==[c] 2007, jobSalary ==[c] 2007
            //
            ...
            if targetNumber != nil {
                ...
                // `datePosted` field matching.
                let datePostedExpression = NSExpression(forKeyPath: "datePosted")
                let datePostedPredicate = NSComparisonPredicate(leftExpression: datePostedExpression, rightExpression: targetNumberExpression, modifier: .DirectPredicateModifier, type: .EqualToPredicateOperatorType, options: .CaseInsensitivePredicateOption)
                
                searchItemsPredicate.append(datePostedPredicate)
                
                // TODO: renaming
                // `price` field matching.
                let lhs = NSExpression(forKeyPath: "jobSalary")
        ...
        // Match up the fields of the job object.
        ...
        resultsController.filteredjobs = filteredResults
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if tableView === self.tableView {
            ...
            selectedjob = resultsTableController.filteredjobs[indexPath.row]
        }
        
        // Set up the detail view controller to show.
        let detailViewController = DetailViewController.detailViewControllerForjob(selectedjob)
